...
global.botName = 'SYSSOLUTIONS©'; // Bot Name
global.botVersion = '2.0.2';
global.botPic = 'https://files.giftedtech.web.id/file/gifted-md.jpg'; // Can use path, can also use link
global.botToken = '8481859663:AAGiVN2l8nef6W4JwqgWsp51YFZbA7OPMF0'; // Replace With Your Bot Token (Get it from BotFather)
global.ownerUsername = 'SysSolutions©'; // Replace With Your Telegram Username(For Bot Owner)
global.timeZone = 'America/Lima'; // Your Time Zone
global.ownerId = [7159171438]; // Replace With Your Owner Chat ID(For Bot Owner), You Can Add More than 1
global.footer = '*Powered by SysSolutions©*';
